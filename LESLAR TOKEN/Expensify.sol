...
abstract contract Expensify is Ownable, Tokenomics, RFI {
     ...
     */
    function canTax(uint256 contractTokenBalance) internal view returns (bool) {
        return
            contractTokenBalance >= accumulatedForTax &&
	...
	*/
    function taxify(uint256 tokenAmount) internal lockTheProcess {
    ...
    modifier legitWallet(address wallet) {
        ...
        require(
            wallet != address(this),
            "Wallet address can't be this contract."
        );
        _;
    }
}
